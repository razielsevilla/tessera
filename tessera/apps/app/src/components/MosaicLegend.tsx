...
export const MosaicLegend: React.FC = () => {
  return (
    <div className="w-full max-w-4xl mx-auto p-4 sm:p-6 mt-6 bg-white dark:bg-gray-800 rounded-xl shadow-lg flex flex-col gap-6 text-sm">
      <h3 className="text-lg font-semibold border-b border-gray-200 dark:border-gray-700 pb-2">Mosaic Legend</h3>
      
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        
        {/* Mood */}
        <div className="flex flex-col gap-2">
          <span className="font-semibold text-gray-700 dark:text-gray-300">Mood (Hue)</span>
        ...
        {/* Social Battery */}
        <div className="flex flex-col gap-2">
          <span className="font-semibold text-gray-700 dark:text-gray-300">Social Battery (Lightness)</span>
          <div className="flex gap-1 items-center justify-between">
            <span className="text-xs text-gray-500">Drained</span>
            <div className="flex gap-1">
              {[1, 3, 5, 7, 10].map(val => (
        ...
        {/* Productivity */}
        <div className="flex flex-col gap-2">
          <span className="font-semibold text-gray-700 dark:text-gray-300">Productivity (Opacity)</span>
          <div className="flex gap-1 items-center justify-between">
        ...
        {/* Frame Tier */}
        <div className="flex flex-col gap-2">
          <span className="font-semibold text-gray-700 dark:text-gray-300">Frame Tier (Border)</span>
